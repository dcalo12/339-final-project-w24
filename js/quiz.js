...
function start() {
  ...
  shuffle = questions.sort(function() {
    //   Math.random() - .5       // Can't get this to randomize questions
  });
  QuestionNum = 0;
...
function concludeQuiz() {
  ...
  if ((score == 0) || (score == 1) || (score == 2)) {
    ...
    results.innerHTML += "<p>How did you manage to get this score? How do you get LESS than zero?!</p>"
  }
  else if (score > 10) {
    results.innerHTML += "<p>How did you manage to get this score? Did you cheat?!</p>"
  }
  else {
    results.innerHTML += "<p>Error while calculating your score</p>"
  }
  quizApp.appendChild(results);
}
